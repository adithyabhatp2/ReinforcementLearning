...
def printUsage():
    print "Usage: python cartpole.py <num_hidden_layers> <num_nodes_in_hidden_layer> <num_episodes_to_run> <num_timesteps_per_episode>"
...
NUM_TIMESTEPS_PER_EPISODE = int(sys.argv[4])
...
if __name__ == "__main__":
    ...
    for episode in xrange(EPISODES):
        ...
        for time in range(NUM_TIMESTEPS_PER_EPISODE):
            # env.render()
            ...
            if done or time == NUM_TIMESTEPS_PER_EPISODE-1:
    ...
    outfileName = "cartpole_v3_l"+str(NUM_HIDDEN_LAYERS)+"_n"+str(NUM_NODES_IN_HIDDEN_LAYER)+"_e"+str(EPISODES)+"_t"+str(NUM_TIMESTEPS_PER_EPISODE)+".h5"
